...
const lambdaHandler = async (
  ...
  metrics.addMetric('PostAuthenticationEventTriggered', MetricUnit.Count, 1);
  ...
  if (
    ...
    metrics.addMetric('NewAccountCreated', MetricUnit.Count, 1);
    ...
    try {
      ...
      if (error instanceof DynamoDBServiceException) {
        if (error.name === 'ConditionalCheckFailedException') {
          ...
          metrics.addMetric('AccountAlreadyExists', MetricUnit.Count, 1);
