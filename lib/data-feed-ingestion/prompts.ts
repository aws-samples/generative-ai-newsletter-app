...
export class ArticleIngestorPromptConfiguration {
  ...
  private static readonly USER_PROMPT_COMPONENT_BACKGROUND =
    'The next section of the prompt is provided by user input.\n' +
  ...
  private static readonly GENERATION_PROMPT =
    'Generate a summary of the article you read.\n'

  private static readonly USER_PROMPT_INCLUDED_PROMPT =
    'Use the provided user prompt as guidance for how you should summarize the information in the article'
  ...
  private static readonly PROMPT_RESPONSE_FORMAT_PROMPT =
    'Respond to the prompt using with the summary in <summary></summary> tags:\n'
  ...
  public static buildPrompt = (
    ...
    return (
      ...
      (summarizationPrompt !== undefined
        ? '<user-prompt>\n' + summarizationPrompt + '</user-prompt>\n'
        : '') +
