      ...
      for (const item of result.Items) {
        try {
          if (
            ...
            metrics.addMetric('ArticlesFound', MetricUnit.Count, 1);
...
const generateEmail = async (
  ...
  metrics.addMetric('HTMLEmailsGenerated', MetricUnit.Count, 1);
  ...
  metrics.addMetric('TextEmailsGenerated', MetricUnit.Count, 1);
...
const storeEmailInS3 = async (
  ...
  try {
    ...
    metrics.addMetric('HTMLEmailsUploaded', MetricUnit.Count, 1);
    ...
    metrics.addMetric('HTMLEmailsFailedToUpload', MetricUnit.Count, 1);
  ...
  try {
    ...
    metrics.addMetric('TextEmailsUploaded', MetricUnit.Count, 1);
    ...
    metrics.addMetric('TextEmailsFailedToUpload', MetricUnit.Count, 1);
  ...
  try {
    ...
    metrics.addMetric('JSONEmailsUploaded', MetricUnit.Count, 1);
    ...
    metrics.addMetric('JSONEmailsFailedToUpload', MetricUnit.Count, 1);
...
const sendNewsletter = async (
  ...
  if (FunctionError !== undefined) {
    ...
    metrics.addMetric('EmailCampaignCreationFailed', MetricUnit.Count, 1);
    throw new Error(FunctionError);
  } else {
    logger.debug('Email campaign created', { Payload });
    metrics.addMetric('EmailCampaignCreated', MetricUnit.Count, 1);
  }
};
