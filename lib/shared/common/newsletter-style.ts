...
export class IntroHeaderStyle {
  ...
  fontFamily: string = 'sans-serif'
  color: string = '#000'
  constructor (values?: { fontSize?: string, textAlign?: string, fontWeight?: string, fontFamily?: string, color?: string }) {
    if (values?.fontSize !== undefined) {
      this.fontSize = values.fontSize
    }
...
export class IntroBodyStyle {
  ...
  fontFamily: string = 'sans-serif'
  color: string = '#000'
  constructor (values?: { fontSize?: string, fontFamily?: string, color?: string }) {
    if (values?.fontSize !== undefined) {
      this.fontSize = values.fontSize
    }
    if (values?.fontFamily !== undefined) {
...
export class ContentHeaderStyle {
  ...
  align: string = 'left'
  fontFamily: string = 'sans-serif'
  constructor (values?: { fontSize?: string, textAlign?: string, fontWeight?: string, fontFamily?: string }) {
    if (values?.fontSize !== undefined) {
      this.fontSize = values.fontSize
    }
    if (values?.textAlign !== undefined) {
...
export class ContentBodyStyle {
  ...
  constructor (values?: { fontSize?: string, textAlign?: string, color?: string, backgroundColor?: string }) {
    if (values?.fontSize !== undefined) {
      this.fontSize = values.fontSize
    }
    if (values?.textAlign !== undefined) {
...
export class NewsletterStyle {
  ...
  constructor (values?: { body?: BodyStyle, content?: ContentStyle, introHeader?: IntroHeaderStyle, introBody?: IntroBodyStyle, contentHeader?: ContentHeaderStyle, contentBody?: ContentBodyStyle }) {
