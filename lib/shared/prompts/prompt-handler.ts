...
export abstract class PromptHandler {
  ...
  constructor (input: {
    ...
    if (input.promptStart !== undefined) {
      this.promptStart = input.promptStart
    }
    if (input.taskContext !== undefined) {
      this.taskContext = input.taskContext
    }
    if (input.toneContext !== undefined) {
      this.toneContext = input.toneContext
    }
    ...
    if (input.promptEnd !== undefined) {
      this.promptEnd = input.promptEnd
    }
  }
