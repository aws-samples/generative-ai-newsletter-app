...
export class NewslettersClient {
    ...
    async getNewsletterEmails(input: GetNewsletterEmailsInput, nextToken?: string | undefined, limit?: number): Promise<GraphQLResult<GraphQLQuery<GetNewsletterEmailsQuery>>> {
        try {
            const result = await client.graphql({
    ...
    async getUserNewsletterSubscriptionStatus(input: UserNewsletterSubscriptionStatusInput): Promise<GraphQLResult<GraphQLQuery<GetUserNewsletterSubscriptionStatusQuery>>> {
        try {
            const result = await client.graphql({
            ...
            return result as GraphQLResult<GraphQLQuery<GetUserNewsletterSubscriptionStatusQuery>>
        }catch(e){
            console.error(e)
        }
        return {} as GraphQLResult<GraphQLQuery<GetUserNewsletterSubscriptionStatusQuery>>
    }

    async getNewsletterSubscriberStats(input: GetNewsletterSubscriberStatsInput): Promise<GraphQLResult<GraphQLQuery<GetNewsletterSubscriberStatsQuery>>> {
        try {
            const result = await client.graphql({
            ...
            return result as GraphQLResult<GraphQLQuery<GetNewsletterSubscriberStatsQuery>>
    ...
    async subscribeToNewsletter(input: SubscribeToNewsletterInput): Promise<GraphQLResult<GraphQLQuery<SubscribeToNewsletterMutation>>> {
        try {
            const result = await client.graphql({
            ...
            return result as GraphQLResult<GraphQLQuery<SubscribeToNewsletterMutation>>
        }catch(e){
            console.error(e)
        }
    ...
    async unsubscribeFromNewsletter(input: UnsubscribeFromNewsletterInput): Promise<GraphQLResult<GraphQLQuery<UnsubscribeFromNewsletterMutation>>> {
        try {
            const result = await client.graphql({
            ...
            return result as GraphQLResult<GraphQLQuery<UnsubscribeFromNewsletterMutation>>
        } catch (e) {
            console.error(e)
        }
