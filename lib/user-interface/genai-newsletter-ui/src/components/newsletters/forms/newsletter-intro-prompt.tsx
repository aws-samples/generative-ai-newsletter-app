...
export default function NewsletterIntroPrompt(props: NewsletterIntroPromptProps) {
    ...
    return (
        <FormField 
            ...
            description="The prompt used to influence your newsletter summary generation">
                <Textarea value={newsletterIntroPrompt} onChange={e => setNewsletterIntroPrompt(e.detail.value)} />
            </FormField>
    )
}