...
export default function NewsletterPreview(props?: NewsletterEmailProps) {
    ...
    const shortSummary = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
    ...
    return (
        <NewsletterEmail
            articleSummaryType={props?.articleSummaryType ?? ArticleSummaryType.SHORT_SUMMARY}
            articles={props?.articles ?? sampleArticles}
            newsletterSummary={props?.newsletterSummary ?? sampleNewsletterSummary}
            appHostName={appContext?.ui?.hostName ?? "ABC.DEF"}
