...
import { ArticleSummaryType, DataFeedSubscription, Newsletter } from "@shared/api/API";
import BaseAppLayout from "../../components/base-app-layout";
import { BreadcrumbGroup, Container, SpaceBetween, SplitPanel, StatusIndicator } from "@cloudscape-design/components";
    ...
    const getNewsletter = useCallback(
        async () => {
            ...
            if (result.errors) {
                ...
                if (result.data.getNewsletter.newsletterStyle !== null && result.data.getNewsletter.newsletterStyle !== undefined) {
                        ...
                        <Container>
                            {(newsletter != undefined && newsletter.subscriptions !== null) ?
                                <NewsletterReviewForm
                                    ...
                                    templatePreview={{setSplitPanelOpen,splitPanelOpen}}
                                />
                                : <>
